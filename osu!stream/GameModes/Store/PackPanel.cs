...
namespace osum.GameModes.Store
{
    public class PackPanel : pSpriteCollection
    {
        ...
        public PackPanel(string packTitle, string packId, bool free)
        {
            ...
            {
                Sprites.Add(s_Thumbnail = new pSpriteWeb(GameBase.serverAddress + "/dl/preview.php?filename=" + PackId + "&format=jpg")
                {
                    DrawDepth = base_depth + 0.02f,
                    Offset = new Vector2(38.5f, 3.8f)
                });
        ...
        private void startNextDownload()
        {
            ...
            lock (PackItems)
            {
                ...
                string downloadPath = GameBase.serverAddress + "/dl/download2.php";
        ...
        internal void AddItem(PackItem item)
        {
            ...
            back.OnClick += delegate
            {
                ...
                string downloadPath = GameBase.serverAddress + "/dl/preview.php";
            ...
            videoPreview.OnClick += delegate
            {
                ...
                StoreMode.ResetAllPreviews(true);
                VideoPreview.DownloadLink = GameBase.serverAddress + "/dl/download2.php?pack=" + PackId + "&filename=" + NetRequest.UrlEncode(item.Filename) + "&id=" + GameBase.Instance.DeviceIdentifier + "&preview=1";
